        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="overflow-hidden rounded-2xl border border-cyan-400/15 bg-[#03182b]">
            <div className="aspect-[4/3] bg-[#07243d]">
              <img
                src="/products/main-4.jpg"
                alt="COMBO 3 TOOL AUTOMATION"
          ...
          <div className="rounded-2xl border border-cyan-400/15 bg-[#03182b] p-5 sm:p-6">
            ...
            <div className="mt-5 rounded-xl border border-cyan-300/10 bg-[#07243d] p-4">
              <p className="text-sm text-cyan-200/70">Combo 6 Tháng</p>
            ...
            <p className="mt-5 text-sm leading-7 text-slate-300 sm:text-base">
              TẶNG APP ĐỌC VOICE - APP BANANA PRO
            </p>

            <div className="mt-6 rounded-xl border border-cyan-300/10 bg-[#07243d] p-4">
              <div className="space-y-3 text-sm text-slate-300">
                <div>
                  <span className="font-semibold text-white">Thời hạn gói:</span> 6 Tháng
                </div>
                <div>
                  <span className="font-semibold text-white">Bàn giao:</span> Cấp key kích hoạt qua Zalo / Facebook
                </div>
                <div>
                  <span className="font-semibold text-white">Hỗ trợ:</span> Hỗ trợ cài đặt và hướng dẫn sử dụng
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-300">
                  <li>Flow - Grok - Whisk</li>
                  <li>Tặng App Voice AI, App Banana Pro</li>
                </ul>
              </div>
            </div>
