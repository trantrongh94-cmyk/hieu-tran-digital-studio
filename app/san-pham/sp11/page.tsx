      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="overflow-hidden rounded-2xl border border-cyan-400/15 bg-[#03182b]">
            <div className="aspect-[4/3] bg-[#07243d]">
              <img
                src="/products/main-11.jpg"
                alt="HMA VPN BẢN QUYỀN KEY - TÀI KHOẢN"
          ...
          <div className="rounded-2xl border border-cyan-400/15 bg-[#03182b] p-5 sm:p-6">
            ...
            <div className="mt-5 rounded-xl border border-cyan-300/10 bg-[#07243d] p-4">
              <p className="text-sm text-cyan-200/70">Key kích hoạt - Tài khoản</p>
            ...
            <div className="mt-6 rounded-xl border border-cyan-300/10 bg-[#07243d] p-4">
              <div className="space-y-3 text-sm text-slate-300">
                ...
                <div>
                  <span className="font-semibold text-white">Bàn giao:</span> Gửi key hoặc tài khoản kích hoạt
                </div>
                <div>
                  <span className="font-semibold text-white">Bảo hành:</span> Bảo hành full hoặc đổi key nếu lỗi
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-6 text-slate-300">
                  <li>Ẩn địa chỉ IP thật</li>
                  <li>Thay đổi IP sang quốc gia khác</li>
                </ul>
              </div>
            </div>
        ...
        <div className="mt-8 rounded-2xl border border-cyan-400/15 bg-[#03182b] p-5 sm:p-6">
          ...
          <div className="mt-4 space-y-4 text-sm leading-7 text-slate-300 sm:text-base">
            <p>* Thời hạn đăng kí: 1 tháng dùng 5 thiết bị</p>
            <p>* Lưu ý Không dùng cho mục đích vi phạm chính sách</p>
            <p>* Lưu ý không được tự ý đổi thông tin tài khoản</p>
